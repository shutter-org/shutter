<template>
  <div
    class="fixed inset-0 z-50 flex flex-col gap-8 overflow-y-scroll py-10 items-center px-12"
  >
    <div
    ...
    >
      ...
      >
        ...
        <div
          id="svg"
          class="w-full aspect-square stack z-50 rounded-lg flex justify-center"
        >
