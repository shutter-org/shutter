<template>
  <div class="fixed inset-0 z-40 flex justify-center overflow-y-scroll">
    <div
    ...
    >
      <publication-component
        class=""
        @vote-up-pub="emit('voteUpPub')"
        @vote-down-pub="emit('voteDownPub')"
        @vote-up-comment="emit('voteUpComment', $event)"
        @vote-down-comment="emit('voteDownComment', $event)"
        @search-tag="emit('searchTag', $event)"
        @add-to-gallery="emit('addToGallery')"
